### Figure 2 (manuscript): Temporal distribution of records for 52 British butterfly species from 1900-2015 by data type (totalling 5,586,795 records). 
###########################################################################
...
# Plot records years
library(ggplot2)
require(wesanderson) # Colour palette
...
### Save
#ggsave("./plots/ms_Figure2.png", width = 17, height = 10, units = c("cm"))